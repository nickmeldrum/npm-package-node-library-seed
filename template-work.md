[[%GITHUB_USER%]] e.g. nickmeldrum
[[%GITHUB_REPO%]] e.g. list-subdirectories-node
[[%GITHUB_DESCRIPTION%]] e.g. "A simple function that allows you to pass in a path to a directory and it will return a string array of subdirectories."
[[%NPM_NAME%]] e.g. list-subdirectories

work: document the opinions/ conventions of this template:
